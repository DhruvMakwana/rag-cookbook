...
| [`multimodal-rag/`](multimodal-rag/) | Retrieval across the sample paper's own real embedded figures + text — a unified CLIP embedding space vs. separate indexes + RRF fusion, measured honestly. Unified CLIP costs 62 points of Recall@3 on plain text questions; a real RRF-fusion bug (no absolute relevance floor with a small image pool) was caught and fixed | ✅ |
